(() => {
  ...
  const art={magic:new Image(),porter:new Image(),rival:new Image(),props:new Image(),cart:new Image(),actions:new Image(),loot:new Image(),motion:new Image(),bomb:new Image(),operator:new Image(),panic:new Image(),blast:new Image(),wheel:new Image(),controls:new Image(),steering:new Image(),gesture:new Image()};let assetsReady=false;
  const assetLoad=Promise.all(Object.entries(art).map(([name,img])=>new Promise((resolve,reject)=>{img.onload=resolve;img.onerror=()=>reject(new Error('角色素材加载失败，请重试'));img.src=name==='magic'?'assets/magic-kit-v16.png':name==='steering'?'assets/operator-steering-v15.png':name==='gesture'?'assets/operator-gesture-v15.png':name==='wheel'?'assets/operator-wheel-v14.png':name==='controls'?'assets/control-props-v14.png':name==='blast'?'assets/blast-v13.png':name==='operator'?'assets/operator-v13.png':name==='panic'?'assets/panic-blast-v13.png':name==='motion'?'assets/rival-motion-v12.png':name==='bomb'?'assets/bomb-kit-v12.png':name==='actions'?'assets/rival-actions-v10.png':name==='loot'?'assets/mining-props-v10.png':`assets/${name}-${name==='props'?'v7':'v8'}.png`;})));
