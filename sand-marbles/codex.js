(function(root,factory){const C=factory();if(typeof module==='object')module.exports=C;else root.SandCodex=C;})(globalThis,()=>{
 ...
 bag:{name:'问号宝袋',icon:'?',text:'撞开紫色问号袋可能得到20分或40分，也可能弹出小炸弹或让全部沙坑回填。炸弹先闪光预警，范围内的珠子会变成同色仅值3分的灰裂废珠，盗宝人可能坐下休息、丢袋跑掉或带袋逃走。回填会暂停计时与操作，保留角色身边的安全空间，重挖旧路不重复算沙量。每袋只开一次，重来结果不变；可绕过袋子。'},
