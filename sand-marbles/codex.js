(function(root,factory){const C=factory();if(typeof module==='object')module.exports=C;else root.SandCodex=C;})(globalThis,()=>{
 ...
 rock:{name:'松动的岩石',icon:'⬟',text:'支撑偏一侧时岩石会倾斜、滚落；太细的土柱会被压碎，无法一直托住大石头。松动约半秒后开始下落。可以砸晕盗宝人 4 秒、清除虫子；也会砸坏矿车！看清落点再动手，损坏的矿车不会接珠，并留在轨道上。'},
 rival:{name:'盗宝人',icon:'⚑',text:'他先伸手抓珠子，再抱起、转身装袋；伸手时珠子仍可滚走，眩晕会让手里的珠子掉下。袋子越满越沉，走得更慢、耗体力更多。超过6颗后，每累计移动1秒有5%概率破袋；破了会边走边漏珠子，接回来仍能得分。他也会累：体力低时擦汗、喝水、休息。听到快速接近的珠子，他会侧耳确认再冲刺。附近爆炸会吓跑他，可能弃袋，也可能带着宝贝离开矿场。抓住他休息、眩晕或弃袋的时机！'},
 porter:{name:'方向盘操作员',icon:'♟',text:'右下角的操作员面向矿区，用方向盘依次控制矿车。右侧亮起哪种颜色的灯，就代表正在控制哪辆车；他会伸手指向接管的矿车。车辆平滑加减速、到端点折返，切换目标前先制动。每次爆炸都会吓到他并短暂刹车，有35%概率逃离控制台；逃岗后本关车队停机，但车斗仍然可以接珠。瞄准移动中的车斗，不要瞄准它原来的位置。可以留一层沙，等矿车停稳再放珠。'},
 ...
 bomb:{name:'引线炸药',icon:'✹',text:'珠子碰到上游的金色压力盘才会点火。沿引线燃烧约1.8秒后，炸开下方挡路的岩石，开出近路或宝袋通道。虚线圈是范围：炸碎石头、晕人、除虫，也可能炸坏矿车。190像素内的盗宝人一定受惊：50%概率丢袋逃跑，原来的珠子会掉出来；否则背袋加速挖出屏幕。每次爆炸也会吓到操作员，他可能逃岗停机。珠子只被推开，不被炸掉。不使用炸药也能通关。'},
 multi:{name:'单轨车队',icon:'⇆',text:'最多四辆矿车共用一条轨道，由同一名操作员依次控制，灯色对应当前目标。矿车不会穿过彼此或交换顺序；撞到邻车时，正在驱动的矿车可以推着暂时停下的矿车一起走；缓冲器接触时会碰响。迎面推挤、残骸或落石挡住时会等候、转向。预留接珠的位置和时机。'},
