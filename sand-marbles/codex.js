(function(root,factory){const C=factory();if(typeof module==='object')module.exports=C;else root.SandCodex=C;})(globalThis,()=>{
 ...
 porter:{name:'摇杆操作员',icon:'♟',text:'一名操作员在下方用摇杆控制矿车，车队会走走停停、折返。每次爆炸都会吓到他并短暂刹车，有35%概率逃离控制台；逃岗后本关车队停机，但车斗仍然可以接珠。瞄准移动中的车斗，不要瞄准它原来的位置。可以留一层沙，等矿车停稳再放珠。'},
 ...
 multi:{name:'单轨车队',icon:'⇆',text:'最多四辆矿车共用一条轨道，由同一名操作员控制。矿车不会穿过彼此或交换顺序；撞到邻车时，正在驱动的矿车可以推着暂时停下的矿车一起走；缓冲器接触时会碰响。迎面推挤、残骸或落石挡住时会等候、转向。预留接珠的位置和时机。'},
