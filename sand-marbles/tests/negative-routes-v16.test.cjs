...
const cases=[
 ...
 {id:13,seed:3,kinds:['bomb']},{id:13,seed:8,kinds:['refill'],delay:.5},
 ...
 {id:15,seed:85,kinds:['bomb','refill'],order:[0,1,2,5,4,3],recoveryOrder:[0,1,2,5,4,3],skipSettledColors:true},
 {id:15,seed:40,kinds:['bomb','bomb']},{id:15,seed:34,kinds:['refill','refill'],order:[0,1,2,5,4,3],recoveryOrder:[0,1,2,5,4,3],skipSettledColors:true}
];
...
for(const c of [{seed:34,reverse:true,score:110},{seed:40,score:103},{seed:85,reverse:true,split:true,blueOutlet:160,score:120},{seed:38,reverse:true,split:true,ticks:1,score:100}])test(`stage 8 seed ${c.seed}: both optional bags complete and recovery still reaches the gate`,()=>{
