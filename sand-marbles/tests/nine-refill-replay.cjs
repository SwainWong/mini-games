...
module.exports=function replayDoubleRefill(mode=0){const w=new World(levels[8],{seed:34}),base=structuredClone(solutions[8]),log=[],inputs=[];let commands=[],cur=0,refills=0,reopen=false;
