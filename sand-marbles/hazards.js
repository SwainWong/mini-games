...
(function(root,factory){const C=factory();if(typeof module==='object')module.exports=C;else root.SandHazards=C;})(globalThis,()=>{
  ...
  class Hazards{
    ...
    step(dt){const w=this.w;let moved=false;
      ...
      for(const r of w.rocks){if(r.broken||r.carriers?.length)continue;r.frameStartPose={x:r.x,y:r.y,angle:r.angle};const before={...r},support=this.supportInfo(r),e=G.extent(r);
